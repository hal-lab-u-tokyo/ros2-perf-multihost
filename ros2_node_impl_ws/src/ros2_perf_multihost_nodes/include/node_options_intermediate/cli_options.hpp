// 二重インクルード防止
#ifndef ROS2_PERF_MULTIHOST_NODES__NODE_OPTIONS_INTERMEDIATE__CLI_OPTIONS_HPP_
#define ROS2_PERF_MULTIHOST_NODES__NODE_OPTIONS_INTERMEDIATE__CLI_OPTIONS_HPP_
